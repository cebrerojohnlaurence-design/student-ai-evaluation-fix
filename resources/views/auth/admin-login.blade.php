...
<body class="min-h-screen flex items-center justify-center antialiased">
        ...
        >
            <div class="flex flex-col items-center mb-3 text-center">
                ...
                >
                    ...
                    <span class="text-[#b91c1c]">Staff Member</span>
                </h1>
                <p class="text-xs text-gray-400 font-medium max-w-[320px]">Login as principal, jhs_coordinator, shs_academic, or shs_techpro</p>
            </div>
    ...
    <script>
        ...
        async function executeAdminLogin() {
            ...
            if (u === "principal" && p === "admin123") {
            ...
            } else if (u === "jhs_coordinator" && p === "admin123") {
                sessionStorage.setItem(
                    "cnhs_session",
                    JSON.stringify({
                        role: "curriculum_coordinator",
                        name: "JHS Curriculum Coordinator",
                        id: "JHS-1",
                        department: "JHS",
                        strand: null
                    }),
                );
                window.location.href = "/curriculum_coordinator/dashboard";
            } else if ((u === "shs_academic" || u === "shs_techpro") && p === "admin123") {
                sessionStorage.setItem(
                    "cnhs_session",
                    JSON.stringify({
                        role: "curriculum_coordinator",
                        name: "SHS " + (u === "shs_academic" ? "Academic" : "Tech-Pro") + " Coordinator",
                        id: u === "shs_academic" ? "SHS-ACAD" : "SHS-TECH",
                        department: "SHS",
                        strand: u === "shs_academic" ? "Academic" : "TechPro"
                    }),
                );
                window.location.href = "/curriculum_coordinator/dashboard";
            } else {
                ...
                fetch('/api/activity-logs', {
                    ...
                    body: JSON.stringify({ 
                        action: 'Failed login attempt on Admin Portal: ' + u, 
                        user: 'System' 
                    })
                }).catch(() => {});
            }
